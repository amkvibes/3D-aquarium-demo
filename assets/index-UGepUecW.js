...
`,Dl=.32,Ol=3.8,kl=3.5,Al=6*.23,jl=6*.87,Ml=[-19,-5,7,19],Nl=[-19,-5,9,19],Pl={xMin:Ml[0]+.5,xMax:Ml[3]-.5,yMin:.4,yMax:5.4,zMin:Nl[0]+.5,zMax:Nl[3]-.5,notchX:Ml[2],notchZ:Nl[1]},Fl=new Ai({color:16119283,roughness:.55,metalness:0,side:2});function Il(e,t,n,r,i,a,o){let s=new Xr(new yi(i,a,o),Fl);s.position.set(t,n,r),e.add(s)}function Ll(e,t,n,r,i){let a=i-Ol/2,o=i+Ol/2;a>t&&Il(e,(t+a)/2,6/2,r,a-t,6,Dl),o<n&&Il(e,(o+n)/2,6/2,r,n-o,6,Dl)}function Rl(e,t,n,r,i){let a=i-Ol/2,o=i+Ol/2;a>n&&Il(e,t,6/2,(n+a)/2,Dl,6,a-n),o<r&&Il(e,t,6/2,(o+r)/2,Dl,6,r-o)}function zl(e,t,n,r,i){let a=[...i].sort((e,t)=>e-t),o=t,s=6-jl;for(let t of a){let n=t-kl/2,i=t+kl/2;n>o&&Il(e,(o+n)/2,6/2,r,n-o,6,Dl),Il(e,t,Al/2,r,kl,Al,Dl),Il(e,t,jl+s/2,r,kl,s,Dl),o=i}o<n&&Il(e,(o+n)/2,6/2,r,n-o,6,Dl)}function Bl(e,t,n,r,i){let a=[...i].sort((e,t)=>e-t),o=n,s=6-jl;for(let n of a){let r=n-kl/2,i=n+kl/2;r>o&&Il(e,t,6/2,(o+r)/2,Dl,6,r-o),Il(e,t,Al/2,n,Dl,Al,kl),Il(e,t,jl+s/2,n,Dl,s,kl),o=i}o<r&&Il(e,t,6/2,(o+r)/2,Dl,6,r-o)}var Vl=new Ai({color:8379354,transparent:!0,opacity:.3,side:0,depthWrite:!1,roughness:0,metalness:0});function Hl(e){let[t,n,r,i]=Ml,[a,o,s,c]=Nl,l=[3058602,2663843,3255980,2794916,2992294,2465951,2794658,2663331],u=[[t,a,n,o,0],[n,a,r,o,1],[t,o,n,s,2],[n,o,r,s,3],[r,o,i,s,4],[t,s,n,c,5],[n,s,r,c,6],[r,s,i,c,7]];for(let[t,n,r,i,a]of u){let o=new Ai({color:l[a],roughness:.7,metalness:.05}),s=new Xr(new bi(r-t,i-n),o);s.rotation.x=-Math.PI/2,s.position.set((t+r)/2,0,(n+i)/2),e.add(s)}let d=.28,f=[[t,a,n,o],[n,a,r,o],[t,o,n,s],[n,o,r,s],[r,o,i,s],[t,s,n,c],[n,s,r,c],[r,s,i,c]];for(let[t,n,r,i]of f){let a=new Xr(new yi(r-t-d*2,6,i-n-d*2),Vl);a.position.set((t+r)/2,6/2,(n+i)/2),e.add(a)}zl(e,t,r,a,[(t+n)/2,(n+r)/2]),Bl(e,r,a,o,[(a+o)/2]),zl(e,r,i,o,[(r+i)/2]),Bl(e,i,o,c,[(o+s)/2,(s+c)/2]),zl(e,t,i,c,[(t+n)/2,(n+r)/2,(r+i)/2]),Bl(e,t,a,c,[(a+o)/2,(o+s)/2,(s+c)/2]),Rl(e,n,a,o,(a+o)/2),Rl(e,n,o,s,(o+s)/2),Rl(e,n,s,c,(s+c)/2),Rl(e,r,o,s,(o+s)/2),Rl(e,r,s,c,(s+c)/2),Ll(e,t,n,o,(t+n)/2),Ll(e,n,r,o,(n+r)/2),Ll(e,t,n,s,(t+n)/2),Ll(e,n,r,s,(n+r)/2),Ll(e,r,i,s,(r+i)/2);let p=(t,n)=>{let r=new ma(16777215,1.2,26,2);r.position.set(t,5.6,n),e.add(r)};p((t+n)/2,(a+o)/2),p((n+r)/2,(a+o)/2),p((t+n)/2,(o+s)/2),p((n+r)/2,(o+s)/2),p((r+i)/2,(o+s)/2),p((t+n)/2,(s+c)/2),p((n+r)/2,(s+c)/2),p((r+i)/2,(s+c)/2);let m=new Xr(new bi(200,200),new Ai({color:13168622,roughness:1,metalness:0}));m.rotation.x=-Math.PI/2,m.position.y=-.05,e.add(m)}var Ul=[[-12,-12,14,14],[1,-12,12,14],[-12,2,14,14],[1,2,12,14],[13,2,12,14],[-12,14,14,10],[1,14,12,10],[13,14,12,10]],Wl=[],Gl=127/255,Kl=219/255,ql=218/255;function Jl(e,t){for(let t of Wl)t.value=e;nu(e,t);let n=Math.sin(e*.38)*.018+Math.sin(e*.67+1.1)*.01;Vl.color.setRGB(Gl+n,Kl+n*.7,ql+n*.5)}var Yl=`
uniform float time;
...
`;function Zl(e){let t={value:0};Wl.push(t);let n=new Oi({uniforms:{time:t},vertexShader:Yl,fragmentShader:Xl,transparent:!0,side:2,depthWrite:!1}),r=6.04,i=new Xr(new bi(26,38,26,38),n);i.rotation.x=-Math.PI/2,i.position.set(-6,r,0),e.add(i);let a=new Xr(new bi(12,24,12,24),n);a.rotation.x=-Math.PI/2,a.position.set(13,r,7),e.add(a)}var Ql=[Ul[0],Ul[2],Ul[4],Ul[7]],$l=45,eu=[];function tu(e){for(let[t,n,r,i]of Ql){let a=$l,o=new Float32Array(a*3),s=new Float32Array(a);for(let e=0;e<a;e++)o[e*3]=t+(Math.random()-.5)*(r-2),o[e*3+1]=Math.random()*6,o[e*3+2]=n+(Math.random()-.5)*(i-2),s[e]=.35+Math.random()*.75;let c=new Dr;c.setAttribute(`position`,new fr(o,3));let l=new pi(c,new ci({color:16777215,size:.13,transparent:!0,opacity:.6,depthWrite:!1,sizeAttenuation:!0}));e.add(l),eu.push({points:l,pos:o,spd:s,cx:t,cz:n,w:r,d:i})}}function nu(e,t){for(let{points:n,pos:r,spd:i,cx:a,cz:o,w:s,d:c}of eu){let l=i.length;for(let n=0;n<l;n++)r[n*3+1]+=i[n]*t,r[n*3]+=Math.sin(e*1.8+n*1.37)*.004,r[n*3+1]>5.85&&(r[n*3]=a+(Math.random()-.5)*(s-2),r[n*3+1]=.1+Math.random()*.4,r[n*3+2]=o+(Math.random()-.5)*(c-2));n.geometry.attributes.position.needsUpdate=!0}}var ru=new Ai({color:13150338,roughness:.85,metalness:0}),iu=new Ai({color:13553358,roughness:.75,metalness:.02}),au=new Ai({color:16052974,roughness:.65,metalness:0}),ou=new Ai({color:15130066,roughness:.9,metalness:0}),su=new Ai({color:3684406,roughness:.55,metalness:.08});function $(e,t,n,r,i,a,o,s){let c=new Xr(new yi(a,o,s),t);c.position.set(n,i+o*.5,r),e.add(c)}function cu(e){$(e,ou,-12,-16.5,0,6,1,2),$(e,ou,-12,-17.4,1,6,.8,.3),$(e,ou,-15,-16.5,0,.4,1.5,2),$(e,ou,-9,-16.5,0,.4,1.5,2),$(e,ru,-12,-14.2,0,2.5,.5,1.2),$(e,su,-16,-6.4,0,3.5,1,.6),$(e,su,-16,-6.4,1,3.5,.08,.6),$(e,iu,1,-17.6,0,9,2,1),$(e,au,1,-17.6,2,9,.1,1),$(e,ru,1,-9,0,2.8,1.4,1.6),$(e,ru,-.9,-9,0,1,.9,1),$(e,ru,2.9,-9,0,1,.9,1),$(e,ru,-.9,-9.4,.9,1,.7,.15),$(e,ru,2.9,-9.4,.9,1,.7,.15),$(e,ou,-15.5,2,0,5,1.4,7.5),$(e,au,-15.5,-1.5,1.4,5,.25,1.5),$(e,ru,-17.7,2,0,.4,2,7.5),$(e,ru,-12.5,-1.5,0,2,1,2),$(e,ru,-7.5,6.5,0,3,4,3),$(e,au,4.5,-2,0,3,.9,3.5),$(e,iu,4.5,-2,.9,3,.15,3.5),$(e,au,-2.5,-3,0,1.4,.9,1.8),$(e,iu,4.5,7,0,3,1.4,1.5),$(e,au,4.5,7,1.4,3,.1,1.5),$(e,ou,15.5,2,0,5,1.4,7.5),$(e,au,15.5,-1.5,1.4,5,.25,1.5),$(e,ru,17.8,2,0,.4,2,7.5),$(e,ru,9.5,-3,0,3,2.5,2),$(e,ru,13.5,-1.5,0,2,1,2),$(e,ou,-15.5,16,0,4.5,1.4,5),$(e,au,-15.5,13.5,1.4,4.5,.25,1.5),$(e,ru,-15.5,17.8,0,4.5,1.5,.4),$(e,ru,-9,11,0,3.5,2.5,2),$(e,au,4.5,16.5,0,3,.9,4),$(e,iu,4.5,16.5,.9,3,.15,4),$(e,au,-2.5,11,0,1.4,.9,2),$(e,iu,-2,17,0,3,1.4,1.5),$(e,au,-2,17,1.4,3,.1,1.5),$(e,ru,9.5,10.5,0,3,1.5,1.5),$(e,ru,16.5,10.5,0,3.5,1.5,1.5),$(e,iu,9.5,12,0,1.5,.9,1.5),$(e,iu,9.5,12.7,.9,1.5,.7,.15),$(e,ru,16,17,0,4.5,4,1.5)}var lu=[-19,-5,7,19],uu=[-19,-5,9,19],du=3.8/2,fu=(e,t)=>[(e+t)/2-du,(e+t)/2+du],pu=[{axis:`x`,pos:lu[0],lo:uu[0],hi:uu[3],gaps:[]},{axis:`x`,pos:lu[3],lo:uu[1],hi:uu[3],gaps:[]},{axis:`x`,pos:lu[2],lo:uu[0],hi:uu[1],gaps:[]},{axis:`z`,pos:uu[0],lo:lu[0],hi:lu[2],gaps:[]},{axis:`z`,pos:uu[3],lo:lu[0],hi:lu[3],gaps:[]},{axis:`z`,pos:uu[1],lo:lu[2],hi:lu[3],gaps:[]},{axis:`x`,pos:lu[1],lo:uu[0],hi:uu[3],gaps:[fu(uu[0],uu[1]),fu(uu[1],uu[2]),fu(uu[2],uu[3])]},{axis:`x`,pos:lu[2],lo:uu[1],hi:uu[3],gaps:[fu(uu[1],uu[2]),fu(uu[2],uu[3])]},{axis:`z`,pos:uu[1],lo:lu[0],hi:lu[2],gaps:[fu(lu[0],lu[1]),fu(lu[1],lu[2])]},{axis:`z`,pos:uu[2],lo:lu[0],hi:lu[3],gaps:[fu(lu[0],lu[1]),fu(lu[1],lu[2]),fu(lu[2],lu[3])]}],mu=new K;function hu(e,t,n){mu.set(0,0,0);for(let r of pu){let i=r.axis===`x`,a=i?e.x:e.z,o=i?e.z:e.x,s=i?t.x:t.z,c=i?t.z:t.x,l=a-r.pos,u=l>=0?1:-1;if(s*u>=0)continue;let d=Math.abs(l);if(d>n||o<r.lo||o>r.hi)continue;let f=Math.abs(s)>.02?o+d/Math.abs(s)*c:o;if(r.gaps.some(([e,t])=>f>e&&f<t))continue;let p=1.5,m=d<=p?1:1-(d-p)/Math.max(n-p,.01);i?mu.x+=u*m:mu.z+=u*m}let r=Pl,i=1.5;return t.y<0&&e.y-r.yMin<i&&(mu.y+=(1-(e.y-r.yMin)/i)*.7),t.y>0&&r.yMax-e.y<i&&(mu.y-=(1-(r.yMax-e.y)/i)*.7),mu}var gu=.52;function _u(e,t){for(let n of pu){let r=n.axis===`x`,i=r?e.z:e.x;if(i<n.lo||i>n.hi)continue;let a=(r?e.x:e.z)-n.pos;if(Math.abs(a)>=gu||n.gaps.some(([e,t])=>i>e&&i<t))continue;let o=a>=0?1:-1;r?(e.x=n.pos+o*(gu+.01),t.x*o<0&&(t.x=Math.abs(t.x)*o*.4)):(e.z=n.pos+o*(gu+.01),t.z*o<0&&(t.z=Math.abs(t.z)*o*.4)),t.x+=(Math.random()-.5)*.12,t.z+=(Math.random()-.5)*.12,t.normalize()}}var vu=new nl({antialias:!0});vu.setSize(window.innerWidth,window.innerHeight),vu.setPixelRatio(window.devicePixelRatio),vu.outputColorSpace=Le,document.body.appendChild(vu.domElement);var yu=new Nn;yu.background=new Y(15661818),yu.fog=new Mn(13693680,.0035);var bu=new fa(50,window.innerWidth/window.innerHeight,.1,500);bu.position.set(20,52,48),bu.lookAt(0,2,0),window.addEventListener(`resize`,()=>{bu.aspect=window.innerWidth/window.innerHeight,bu.updateProjectionMatrix(),vu.setSize(window.innerWidth,window.innerHeight)});var xu=new fl(bu,vu.domElement);xu.target.set(0,6/2,0),xu.enableDamping=!0,xu.dampingFactor=.06,xu.autoRotate=!1,xu.minDistance=15,xu.maxDistance=130,xu.maxPolarAngle=Math.PI*.78,yu.add(new va(13693168,2.8));var Su=new _a(16777215,2.2);Su.position.set(-10,60,-20),yu.add(Su);var Cu=new _a(16773352,.9);Cu.position.set(30,25,30),yu.add(Cu),Hl(yu),Zl(yu),tu(yu);var wu={BigFishA:{fishLength:10,fishWaveLength:-1,fishBendAmount:.5,tailSpeed:1.5,swimSpeed:2,turnRate:.9,scale:.25},BigFishB:{fishLength:10,fishWaveLength:-.7,fishBendAmount:.3,tailSpeed:1,swimSpeed:2.2,turnRate:.9,scale:.25},MediumFishA:{fishLength:10,fishWaveLength:-2,fishBendAmount:2,tailSpeed:1,swimSpeed:3.5,turnRate:2.2,scale:.6},MediumFishB:{fishLength:10,fishWaveLength:-2,fishBendAmount:2,tailSpeed:3,swimSpeed:3.2,turnRate:2.2,scale:.8},SmallFishA:{fishLength:10,fishWaveLength:1,fishBendAmount:2,tailSpeed:10,swimSpeed:5.5,turnRate:5,scale:1.5}},Tu=[{type:`BigFishA`,count:1},{type:`BigFishB`,count:1},{type:`MediumFishA`,count:3},{type:`MediumFishB`,count:4},{type:`SmallFishA`,count:8}],Eu=new K(-10,60,-20);function Du(e,t,n){return new Oi({uniforms:{time:{value:0},fishLength:{value:n.fishLength},fishWaveLength:{value:n.fishWaveLength},fishBendAmount:{value:n.fishBendAmount},lightWorldPos:{value:Eu},diffuseMap:{value:e},normalMapTex:{value:t},lightColor:{value:new Wt(1,1,1,1)},ambient:{value:new Wt(.55,.6,.62,1)},specular:{value:new Wt(.9,.95,1,1)},shininess:{value:50},specularFactor:{value:1}},vertexShader:Tl,fragmentShader:El,side:0})}var Ou=new $i;function ku(e,t=!0){return new Promise(n=>{Ou.load(`/3D-aquarium-demo/assets/${e}`,e=>{e.colorSpace=t?Le:Re,n(e)},void 0,()=>n(null))})}async function Au(e){let{fields:t,textures:n}=(await(await fetch(`/3D-aquarium-demo/assets/${e}.js`)).json()).models[0],r=new Dr;r.setAttribute(`position`,new fr(new Float32Array(t.position.data),3)),r.setAttribute(`normal`,new fr(new Float32Array(t.normal.data),3)),r.setAttribute(`uv`,new fr(new Float32Array(t.texCoord.data),2)),r.setAttribute(`a_tangent`,new fr(new Float32Array(t.tangent.data),3)),r.setAttribute(`a_binormal`,new fr(new Float32Array(t.binormal.data),3)),r.setIndex(new fr(new Uint16Array(t.indices.data),1)),r.computeBoundingBox();let i=new K;r.boundingBox.getCenter(i),r.translate(-i.x,-i.y,-i.z);let[a,o]=await Promise.all([n.diffuse?ku(n.diffuse,!0):Promise.resolve(null),n.normalMap?ku(n.normalMap,!1):Promise.resolve(null)]);return{geo:r,diffuseMap:a,normalMapTex:o}}function ju(e,t){return e+Math.random()*(t-e)}function Mu(){let e=Math.random()*Math.PI*2,t=ju(-.12,.12);return new K(Math.cos(e),t,Math.sin(e)).normalize()}function Nu(){let e=Pl;for(let t=0;t<60;t++){let t=new K(ju(e.xMin+2,e.xMax-2),ju(e.yMin+.3,e.yMax-.3),ju(e.zMin+2,e.zMax-2));if(!(t.x>e.notchX-2&&t.z<e.notchZ+2))return t}return new K(ju(e.xMin+2,e.notchX-2),ju(e.yMin+.3,e.yMax-.3),ju(e.notchZ+2,e.zMax-2))}function Pu(e,t){let n=Pl,r=!1,i=(n,i,a)=>{e[n]<i&&(e[n]=i,t[n]<0&&(t[n]*=-1),r=!0),e[n]>a&&(e[n]=a,t[n]>0&&(t[n]*=-1),r=!0)};i(`x`,n.xMin,n.xMax),i(`y`,n.yMin,n.yMax),i(`z`,n.zMin,n.zMax),e.x>n.notchX&&e.z<n.notchZ&&(e.x-n.notchX>=n.notchZ-e.z?(e.x=n.notchX,t.x>0&&(t.x*=-1)):(e.z=n.notchZ,t.z<0&&(t.z*=-1)),r=!0),r&&(t.x+=ju(-.08,.08),t.z+=ju(-.08,.08),t.normalize())}var Fu=document.getElementById(`loading-fill`),Iu=document.getElementById(`loading-pct`);function Lu(e){let t=Math.round(e*100);Fu&&(Fu.style.width=t+`%`),Iu&&(Iu.textContent=t+`%`)}function Ru(){let e=document.getElementById(`loading`);e&&(e.classList.add(`fade-out`),e.addEventListener(`transitionend`,()=>e.remove(),{once:!0}))}var zu=[];async function Bu(){let e=[...new Set(Tu.map(e=>e.type))],t=e.length,n=0;Lu(.05);let r=Object.fromEntries(await Promise.all(e.map(async e=>{let r=await Au(e);return n++,Lu(.05+n/t*.9),[e,r]}))),i=[];for(let{type:e,count:t}of Tu){let{geo:n,diffuseMap:a,normalMapTex:o}=r[e],s=wu[e];for(let r=0;r<t;r++){let t=new Xr(n,Du(a,o,s));t.scale.setScalar(s.scale);let r;for(let e=0;e<40&&(r=Nu(),!i.every(e=>e.distanceTo(r)>=4.5));e++);i.push(r.clone()),t.position.copy(r);let c=Mu(),l=c.clone(),u=e.startsWith(`Big`),d=e.startsWith(`Small`),f=u?ju(.5,1.1):d?ju(.7,1.6):ju(.6,1.4),p=s.swimSpeed*f;zu.push({mesh:t,pos:r,vel:c,facingDir:l,swimSpeed:p,currentSpeed:p,tailSpeed:s.tailSpeed*ju(.75,1.3),turnRate:s.turnRate,timeOffset:Math.random()*Math.PI*2,wanderFreq:ju(.3,1.1),wanderPhase:Math.random()*Math.PI*2,wanderAmt:ju(.35,1.1),pauseTimer:0,pauseChance:ju(1e-4,4e-4)}),yu.add(t)}}Lu(1),setTimeout(Ru,300)}var Vu=new Ca,Hu=0;function Uu(){requestAnimationFrame(Uu),Vu.update();let e=Vu.getElapsed(),t=Math.min(e-Hu,.05);Hu=e;for(let n of zu){{let r=Math.sin(e*n.wanderFreq+n.wanderPhase)*n.wanderAmt*t,i=-n.vel.z,a=n.vel.x;n.vel.x+=i*r,n.vel.z+=a*r,n.vel.normalize()}{let e=3+n.swimSpeed*.3,r=hu(n.pos,n.vel,e),i=r.length();if(i>.001){let e=Math.min(1,n.turnRate*i*t*6);n.vel.lerp(r.normalize(),e).normalize()}}n.pauseTimer>0?(n.pauseTimer-=t,n.currentSpeed=Math.max(.05,n.currentSpeed-n.swimSpeed*t*2.5)):(n.currentSpeed=Math.min(n.swimSpeed,n.currentSpeed+n.swimSpeed*t*1.2),Math.random()<n.pauseChance&&(n.pauseTimer=ju(.6,2.8))),n.pos.addScaledVector(n.vel,n.currentSpeed*t),Pu(n.pos,n.vel),_u(n.pos,n.vel),n.facingDir.lerp(n.vel,Math.min(1,n.turnRate*t)).normalize(),n.mesh.position.copy(n.pos),n.mesh.rotation.y=Math.atan2(n.facingDir.x,n.facingDir.z),n.mesh.rotation.x=-Math.asin(Math.max(-.9,Math.min(.9,n.facingDir.y)));let r=n.tailSpeed*(n.currentSpeed/Math.max(n.swimSpeed,.01));n.mesh.material.uniforms.time.value=e*r+n.timeOffset}Jl(e,t),xu.update(),vu.render(yu,bu)}cu(yu),Bu().catch(console.error),Uu();