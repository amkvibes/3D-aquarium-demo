...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ho(e,t,n){let r=new Float32Array(eo),i=new K(0,1,0);return new Oi({name:`SphericalGaussianBlur`,defines:{n:eo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:vo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function go(){return new Oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:vo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _o(){return new Oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vo(),fragmentShader:`
	...
	`}var yo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new hi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Dl=.32,Ol=3.8,kl=3.5,Al=6*.23,jl=6*.87,Ml=[-19,-5,7,19],Nl=[-19,-5,9,19],Pl={xMin:Ml[0]+.5,xMax:Ml[3]-.5,yMin:.4,yMax:5.4,zMin:Nl[0]+.5,zMax:Nl[3]-.5,notchX:Ml[2],notchZ:Nl[1]},Fl=new Ai({color:16119283,roughness:.55,metalness:0,side:2});function Il(e,t,n,r,i,a,o){let s=new Xr(new yi(i,a,o),Fl);s.position.set(t,n,r),e.add(s)}function Ll(e,t,n,r,i){let a=i-Ol/2,o=i+Ol/2;a>t&&Il(e,(t+a)/2,6/2,r,a-t,6,Dl),o<n&&Il(e,(o+n)/2,6/2,r,n-o,6,Dl)}function Rl(e,t,n,r,i){let a=i-Ol/2,o=i+Ol/2;a>n&&Il(e,t,6/2,(n+a)/2,Dl,6,a-n),o<r&&Il(e,t,6/2,(o+r)/2,Dl,6,r-o)}function zl(e,t,n,r,i){let a=[...i].sort((e,t)=>e-t),o=t,s=6-jl;for(let t of a){let n=t-kl/2,i=t+kl/2;n>o&&Il(e,(o+n)/2,6/2,r,n-o,6,Dl),Il(e,t,Al/2,r,kl,Al,Dl),Il(e,t,jl+s/2,r,kl,s,Dl),o=i}o<n&&Il(e,(o+n)/2,6/2,r,n-o,6,Dl)}function Bl(e,t,n,r,i){let a=[...i].sort((e,t)=>e-t),o=n,s=6-jl;for(let n of a){let r=n-kl/2,i=n+kl/2;r>o&&Il(e,t,6/2,(o+r)/2,Dl,6,r-o),Il(e,t,Al/2,n,Dl,Al,kl),Il(e,t,jl+s/2,n,Dl,s,kl),o=i}o<r&&Il(e,t,6/2,(o+r)/2,Dl,6,r-o)}function Vl(e){let[t,n,r,i]=Ml,[a,o,s,c]=Nl,l=[5625298,5099468,5888213,5229258,5427919,4704453,5360842,5099214],u=[[t,a,n,o,0],[n,a,r,o,1],[t,o,n,s,2],[n,o,r,s,3],[r,o,i,s,4],[t,s,n,c,5],[n,s,r,c,6],[r,s,i,c,7]];for(let[t,n,r,i,a]of u){let o=new Ai({color:l[a],roughness:.7,metalness:.05}),s=new Xr(new bi(r-t,i-n),o);s.rotation.x=-Math.PI/2,s.position.set((t+r)/2,0,(n+i)/2),e.add(s)}let d=new Ai({color:8379354,transparent:!0,opacity:.28,side:0,depthWrite:!1,roughness:0,metalness:0}),f=.28,p=[[t,a,n,o],[n,a,r,o],[t,o,n,s],[n,o,r,s],[r,o,i,s],[t,s,n,c],[n,s,r,c],[r,s,i,c]];for(let[t,n,r,i]of p){let a=new Xr(new yi(r-t-f*2,6,i-n-f*2),d);a.position.set((t+r)/2,6/2,(n+i)/2),e.add(a)}zl(e,t,r,a,[(t+n)/2,(n+r)/2]),Bl(e,r,a,o,[(a+o)/2]),zl(e,r,i,o,[(r+i)/2]),Bl(e,i,o,c,[(o+s)/2,(s+c)/2]),zl(e,t,i,c,[(t+n)/2,(n+r)/2,(r+i)/2]),Bl(e,t,a,c,[(a+o)/2,(o+s)/2,(s+c)/2]),Rl(e,n,a,o,(a+o)/2),Rl(e,n,o,s,(o+s)/2),Rl(e,n,s,c,(s+c)/2),Rl(e,r,o,s,(o+s)/2),Rl(e,r,s,c,(s+c)/2),Ll(e,t,n,o,(t+n)/2),Ll(e,n,r,o,(n+r)/2),Ll(e,t,n,s,(t+n)/2),Ll(e,n,r,s,(n+r)/2),Ll(e,r,i,s,(r+i)/2);let m=(t,n)=>{let r=new ma(16777215,1.2,26,2);r.position.set(t,5.6,n),e.add(r)};m((t+n)/2,(a+o)/2),m((n+r)/2,(a+o)/2),m((t+n)/2,(o+s)/2),m((n+r)/2,(o+s)/2),m((r+i)/2,(o+s)/2),m((t+n)/2,(s+c)/2),m((n+r)/2,(s+c)/2),m((r+i)/2,(s+c)/2);let h=new Xr(new bi(200,200),new Ai({color:13168622,roughness:1,metalness:0}));h.rotation.x=-Math.PI/2,h.position.y=-.05,e.add(h)}var Hl=[[-12,-12,14,14],[1,-12,12,14],[-12,2,14,14],[1,2,12,14],[13,2,12,14],[-12,14,14,10],[1,14,12,10],[13,14,12,10]],Ul=[];function Wl(e,t){for(let t of Ul)t.value=e;tu(e,t)}var Gl=`
varying vec2 v_uv;
void main() {
  v_uv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function ql(e){let t={value:0};Ul.push(t);let n=new Oi({uniforms:{time:t},vertexShader:Gl,fragmentShader:Kl,transparent:!0,blending:2,depthWrite:!1,side:0});for(let[t,r,i,a]of Hl){let o=new Xr(new bi(i-.3,a-.3),n);o.rotation.x=-Math.PI/2,o.position.set(t,.08,r),e.add(o)}}var Jl=`
uniform float time;
...
`;function Xl(e){let t={value:0};Ul.push(t);let n=new Oi({uniforms:{time:t},vertexShader:Jl,fragmentShader:Yl,transparent:!0,side:2,depthWrite:!1}),r=6.04,i=new Xr(new bi(26,38,26,38),n);i.rotation.x=-Math.PI/2,i.position.set(-6,r,0),e.add(i);let a=new Xr(new bi(12,24,12,24),n);a.rotation.x=-Math.PI/2,a.position.set(13,r,7),e.add(a)}var Zl=[Hl[0],Hl[2],Hl[4],Hl[7]],Ql=45,$l=[];function eu(e){for(let[t,n,r,i]of Zl){let a=Ql,o=new Float32Array(a*3),s=new Float32Array(a);for(let e=0;e<a;e++)o[e*3]=t+(Math.random()-.5)*(r-2),o[e*3+1]=Math.random()*6,o[e*3+2]=n+(Math.random()-.5)*(i-2),s[e]=.35+Math.random()*.75;let c=new Dr;c.setAttribute(`position`,new fr(o,3));let l=new pi(c,new ci({color:16777215,size:.13,transparent:!0,opacity:.6,depthWrite:!1,sizeAttenuation:!0}));e.add(l),$l.push({points:l,pos:o,spd:s,cx:t,cz:n,w:r,d:i})}}function tu(e,t){for(let{points:n,pos:r,spd:i,cx:a,cz:o,w:s,d:c}of $l){let l=i.length;for(let n=0;n<l;n++)r[n*3+1]+=i[n]*t,r[n*3]+=Math.sin(e*1.8+n*1.37)*.004,r[n*3+1]>5.85&&(r[n*3]=a+(Math.random()-.5)*(s-2),r[n*3+1]=.1+Math.random()*.4,r[n*3+2]=o+(Math.random()-.5)*(c-2));n.geometry.attributes.position.needsUpdate=!0}}var nu=new Ai({color:13150338,roughness:.85,metalness:0}),ru=new Ai({color:13553358,roughness:.75,metalness:.02}),iu=new Ai({color:16052974,roughness:.65,metalness:0}),au=new Ai({color:15130066,roughness:.9,metalness:0}),ou=new Ai({color:3684406,roughness:.55,metalness:.08});function $(e,t,n,r,i,a,o,s){let c=new Xr(new yi(a,o,s),t);c.position.set(n,i+o*.5,r),e.add(c)}function su(e){$(e,au,-12,-16.5,0,6,1,2),$(e,au,-12,-17.4,1,6,.8,.3),$(e,au,-15,-16.5,0,.4,1.5,2),$(e,au,-9,-16.5,0,.4,1.5,2),$(e,nu,-12,-14.2,0,2.5,.5,1.2),$(e,ou,-16,-6.4,0,3.5,1,.6),$(e,ou,-16,-6.4,1,3.5,.08,.6),$(e,ru,1,-17.6,0,9,2,1),$(e,iu,1,-17.6,2,9,.1,1),$(e,nu,1,-9,0,2.8,1.4,1.6),$(e,nu,-.9,-9,0,1,.9,1),$(e,nu,2.9,-9,0,1,.9,1),$(e,nu,-.9,-9.4,.9,1,.7,.15),$(e,nu,2.9,-9.4,.9,1,.7,.15),$(e,au,-15.5,2,0,5,1.4,7.5),$(e,iu,-15.5,-1.5,1.4,5,.25,1.5),$(e,nu,-17.7,2,0,.4,2,7.5),$(e,nu,-12.5,-1.5,0,2,1,2),$(e,nu,-7.5,6.5,0,3,4,3),$(e,iu,4.5,-2,0,3,.9,3.5),$(e,ru,4.5,-2,.9,3,.15,3.5),$(e,iu,-2.5,-3,0,1.4,.9,1.8),$(e,ru,4.5,7,0,3,1.4,1.5),$(e,iu,4.5,7,1.4,3,.1,1.5),$(e,au,15.5,2,0,5,1.4,7.5),$(e,iu,15.5,-1.5,1.4,5,.25,1.5),$(e,nu,17.8,2,0,.4,2,7.5),$(e,nu,9.5,-3,0,3,2.5,2),$(e,nu,13.5,-1.5,0,2,1,2),$(e,au,-15.5,16,0,4.5,1.4,5),$(e,iu,-15.5,13.5,1.4,4.5,.25,1.5),$(e,nu,-15.5,17.8,0,4.5,1.5,.4),$(e,nu,-9,11,0,3.5,2.5,2),$(e,iu,4.5,16.5,0,3,.9,4),$(e,ru,4.5,16.5,.9,3,.15,4),$(e,iu,-2.5,11,0,1.4,.9,2),$(e,ru,-2,17,0,3,1.4,1.5),$(e,iu,-2,17,1.4,3,.1,1.5),$(e,nu,9.5,10.5,0,3,1.5,1.5),$(e,nu,16.5,10.5,0,3.5,1.5,1.5),$(e,ru,9.5,12,0,1.5,.9,1.5),$(e,ru,9.5,12.7,.9,1.5,.7,.15),$(e,nu,16,17,0,4.5,4,1.5)}var cu=[-19,-5,7,19],lu=[-19,-5,9,19],uu=3.8/2,du=(e,t)=>[(e+t)/2-uu,(e+t)/2+uu],fu=[{axis:`x`,pos:cu[0],lo:lu[0],hi:lu[3],gaps:[]},{axis:`x`,pos:cu[3],lo:lu[1],hi:lu[3],gaps:[]},{axis:`x`,pos:cu[2],lo:lu[0],hi:lu[1],gaps:[]},{axis:`z`,pos:lu[0],lo:cu[0],hi:cu[2],gaps:[]},{axis:`z`,pos:lu[3],lo:cu[0],hi:cu[3],gaps:[]},{axis:`z`,pos:lu[1],lo:cu[2],hi:cu[3],gaps:[]},{axis:`x`,pos:cu[1],lo:lu[0],hi:lu[3],gaps:[du(lu[0],lu[1]),du(lu[1],lu[2]),du(lu[2],lu[3])]},{axis:`x`,pos:cu[2],lo:lu[1],hi:lu[3],gaps:[du(lu[1],lu[2]),du(lu[2],lu[3])]},{axis:`z`,pos:lu[1],lo:cu[0],hi:cu[2],gaps:[du(cu[0],cu[1]),du(cu[1],cu[2])]},{axis:`z`,pos:lu[2],lo:cu[0],hi:cu[3],gaps:[du(cu[0],cu[1]),du(cu[1],cu[2]),du(cu[2],cu[3])]}],pu=new K;function mu(e,t,n){pu.set(0,0,0);for(let r of fu){let i=r.axis===`x`,a=i?e.x:e.z,o=i?e.z:e.x,s=i?t.x:t.z,c=i?t.z:t.x,l=a-r.pos,u=l>=0?1:-1;if(s*u>=0)continue;let d=Math.abs(l);if(d>n||o<r.lo||o>r.hi)continue;let f=Math.abs(s)>.02?o+d/Math.abs(s)*c:o;if(r.gaps.some(([e,t])=>f>e&&f<t))continue;let p=1.5,m=d<=p?1:1-(d-p)/Math.max(n-p,.01);i?pu.x+=u*m:pu.z+=u*m}let r=Pl,i=1.5;return t.y<0&&e.y-r.yMin<i&&(pu.y+=(1-(e.y-r.yMin)/i)*.7),t.y>0&&r.yMax-e.y<i&&(pu.y-=(1-(r.yMax-e.y)/i)*.7),pu}var hu=.52;function gu(e,t){for(let n of fu){let r=n.axis===`x`,i=r?e.z:e.x;if(i<n.lo||i>n.hi)continue;let a=(r?e.x:e.z)-n.pos;if(Math.abs(a)>=hu||n.gaps.some(([e,t])=>i>e&&i<t))continue;let o=a>=0?1:-1;r?(e.x=n.pos+o*(hu+.01),t.x*o<0&&(t.x=Math.abs(t.x)*o*.4)):(e.z=n.pos+o*(hu+.01),t.z*o<0&&(t.z=Math.abs(t.z)*o*.4)),t.x+=(Math.random()-.5)*.12,t.z+=(Math.random()-.5)*.12,t.normalize()}}var _u=new nl({antialias:!0});_u.setSize(window.innerWidth,window.innerHeight),_u.setPixelRatio(window.devicePixelRatio),_u.outputColorSpace=Le,document.body.appendChild(_u.domElement);var vu=new Nn;vu.background=new Y(15661818),vu.fog=new Mn(13693680,.0035);var yu=new fa(50,window.innerWidth/window.innerHeight,.1,500);yu.position.set(20,52,48),yu.lookAt(0,2,0),window.addEventListener(`resize`,()=>{yu.aspect=window.innerWidth/window.innerHeight,yu.updateProjectionMatrix(),_u.setSize(window.innerWidth,window.innerHeight)});var bu=new fl(yu,_u.domElement);bu.target.set(0,6/2,0),bu.enableDamping=!0,bu.dampingFactor=.06,bu.autoRotate=!1,bu.minDistance=15,bu.maxDistance=130,bu.maxPolarAngle=Math.PI*.78,vu.add(new va(13693168,2.8));var xu=new _a(16777215,2.2);xu.position.set(-10,60,-20),vu.add(xu);var Su=new _a(16773352,.9);Su.position.set(30,25,30),vu.add(Su),Vl(vu),ql(vu),Xl(vu),eu(vu);var Cu={BigFishA:{fishLength:10,fishWaveLength:-1,fishBendAmount:.5,tailSpeed:1.5,swimSpeed:2,turnRate:.9,scale:.25},BigFishB:{fishLength:10,fishWaveLength:-.7,fishBendAmount:.3,tailSpeed:1,swimSpeed:2.2,turnRate:.9,scale:.25},MediumFishA:{fishLength:10,fishWaveLength:-2,fishBendAmount:2,tailSpeed:1,swimSpeed:3.5,turnRate:2.2,scale:.6},MediumFishB:{fishLength:10,fishWaveLength:-2,fishBendAmount:2,tailSpeed:3,swimSpeed:3.2,turnRate:2.2,scale:.8},SmallFishA:{fishLength:10,fishWaveLength:1,fishBendAmount:2,tailSpeed:10,swimSpeed:5.5,turnRate:5,scale:1.5}},wu=[{type:`BigFishA`,count:1},{type:`BigFishB`,count:1},{type:`MediumFishA`,count:3},{type:`MediumFishB`,count:4},{type:`SmallFishA`,count:8}],Tu=new K(-10,60,-20);function Eu(e,t,n){return new Oi({uniforms:{time:{value:0},fishLength:{value:n.fishLength},fishWaveLength:{value:n.fishWaveLength},fishBendAmount:{value:n.fishBendAmount},lightWorldPos:{value:Tu},diffuseMap:{value:e},normalMapTex:{value:t},lightColor:{value:new Wt(1,1,1,1)},ambient:{value:new Wt(.55,.6,.62,1)},specular:{value:new Wt(.9,.95,1,1)},shininess:{value:50},specularFactor:{value:1}},vertexShader:Tl,fragmentShader:El,side:0})}var Du=new $i;function Ou(e,t=!0){return new Promise(n=>{Du.load(`/3D-aquarium-demo/assets/${e}`,e=>{e.colorSpace=t?Le:Re,n(e)},void 0,()=>n(null))})}async function ku(e){let{fields:t,textures:n}=(await(await fetch(`/3D-aquarium-demo/assets/${e}.js`)).json()).models[0],r=new Dr;r.setAttribute(`position`,new fr(new Float32Array(t.position.data),3)),r.setAttribute(`normal`,new fr(new Float32Array(t.normal.data),3)),r.setAttribute(`uv`,new fr(new Float32Array(t.texCoord.data),2)),r.setAttribute(`a_tangent`,new fr(new Float32Array(t.tangent.data),3)),r.setAttribute(`a_binormal`,new fr(new Float32Array(t.binormal.data),3)),r.setIndex(new fr(new Uint16Array(t.indices.data),1)),r.computeBoundingBox();let i=new K;r.boundingBox.getCenter(i),r.translate(-i.x,-i.y,-i.z);let[a,o]=await Promise.all([n.diffuse?Ou(n.diffuse,!0):Promise.resolve(null),n.normalMap?Ou(n.normalMap,!1):Promise.resolve(null)]);return{geo:r,diffuseMap:a,normalMapTex:o}}function Au(e,t){return e+Math.random()*(t-e)}function ju(){let e=Math.random()*Math.PI*2,t=Au(-.12,.12);return new K(Math.cos(e),t,Math.sin(e)).normalize()}function Mu(){let e=Pl;for(let t=0;t<60;t++){let t=new K(Au(e.xMin+2,e.xMax-2),Au(e.yMin+.3,e.yMax-.3),Au(e.zMin+2,e.zMax-2));if(!(t.x>e.notchX-2&&t.z<e.notchZ+2))return t}return new K(Au(e.xMin+2,e.notchX-2),Au(e.yMin+.3,e.yMax-.3),Au(e.notchZ+2,e.zMax-2))}function Nu(e,t){let n=Pl,r=!1,i=(n,i,a)=>{e[n]<i&&(e[n]=i,t[n]<0&&(t[n]*=-1),r=!0),e[n]>a&&(e[n]=a,t[n]>0&&(t[n]*=-1),r=!0)};i(`x`,n.xMin,n.xMax),i(`y`,n.yMin,n.yMax),i(`z`,n.zMin,n.zMax),e.x>n.notchX&&e.z<n.notchZ&&(e.x-n.notchX>=n.notchZ-e.z?(e.x=n.notchX,t.x>0&&(t.x*=-1)):(e.z=n.notchZ,t.z<0&&(t.z*=-1)),r=!0),r&&(t.x+=Au(-.08,.08),t.z+=Au(-.08,.08),t.normalize())}var Pu=document.getElementById(`loading-fill`),Fu=document.getElementById(`loading-pct`);function Iu(e){let t=Math.round(e*100);Pu&&(Pu.style.width=t+`%`),Fu&&(Fu.textContent=t+`%`)}function Lu(){let e=document.getElementById(`loading`);e&&(e.classList.add(`fade-out`),e.addEventListener(`transitionend`,()=>e.remove(),{once:!0}))}var Ru=[];async function zu(){let e=[...new Set(wu.map(e=>e.type))],t=e.length,n=0;Iu(.05);let r=Object.fromEntries(await Promise.all(e.map(async e=>{let r=await ku(e);return n++,Iu(.05+n/t*.9),[e,r]}))),i=[];for(let{type:e,count:t}of wu){let{geo:n,diffuseMap:a,normalMapTex:o}=r[e],s=Cu[e];for(let r=0;r<t;r++){let t=new Xr(n,Eu(a,o,s));t.scale.setScalar(s.scale);let r;for(let e=0;e<40&&(r=Mu(),!i.every(e=>e.distanceTo(r)>=4.5));e++);i.push(r.clone()),t.position.copy(r);let c=ju(),l=c.clone(),u=e.startsWith(`Big`),d=e.startsWith(`Small`),f=u?Au(.5,1.1):d?Au(.7,1.6):Au(.6,1.4),p=s.swimSpeed*f;Ru.push({mesh:t,pos:r,vel:c,facingDir:l,swimSpeed:p,currentSpeed:p,tailSpeed:s.tailSpeed*Au(.75,1.3),turnRate:s.turnRate,timeOffset:Math.random()*Math.PI*2,wanderFreq:Au(.3,1.1),wanderPhase:Math.random()*Math.PI*2,wanderAmt:Au(.35,1.1),pauseTimer:0,pauseChance:Au(1e-4,4e-4)}),vu.add(t)}}Iu(1),setTimeout(Lu,300)}var Bu=new Ca,Vu=0;function Hu(){requestAnimationFrame(Hu),Bu.update();let e=Bu.getElapsed(),t=Math.min(e-Vu,.05);Vu=e;for(let n of Ru){{let r=Math.sin(e*n.wanderFreq+n.wanderPhase)*n.wanderAmt*t,i=-n.vel.z,a=n.vel.x;n.vel.x+=i*r,n.vel.z+=a*r,n.vel.normalize()}{let e=3+n.swimSpeed*.3,r=mu(n.pos,n.vel,e),i=r.length();if(i>.001){let e=Math.min(1,n.turnRate*i*t*6);n.vel.lerp(r.normalize(),e).normalize()}}n.pauseTimer>0?(n.pauseTimer-=t,n.currentSpeed=Math.max(.05,n.currentSpeed-n.swimSpeed*t*2.5)):(n.currentSpeed=Math.min(n.swimSpeed,n.currentSpeed+n.swimSpeed*t*1.2),Math.random()<n.pauseChance&&(n.pauseTimer=Au(.6,2.8))),n.pos.addScaledVector(n.vel,n.currentSpeed*t),Nu(n.pos,n.vel),gu(n.pos,n.vel),n.facingDir.lerp(n.vel,Math.min(1,n.turnRate*t)).normalize(),n.mesh.position.copy(n.pos),n.mesh.rotation.y=Math.atan2(n.facingDir.x,n.facingDir.z),n.mesh.rotation.x=-Math.asin(Math.max(-.9,Math.min(.9,n.facingDir.y)));let r=n.tailSpeed*(n.currentSpeed/Math.max(n.swimSpeed,.01));n.mesh.material.uniforms.time.value=e*r+n.timeOffset}Wl(e,t),bu.update(),_u.render(vu,yu)}su(vu),zu().catch(console.error),Hu();