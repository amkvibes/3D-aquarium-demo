...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function go(e,t,n){let r=new Float32Array(to),i=new G(0,1,0);return new ki({name:`SphericalGaussianBlur`,defines:{n:to,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:yo(),fragmentShader:`
	...
	`}var bo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new gi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Ol=.32,kl=3.8,Al=3.5,jl=6*.23,Ml=6*.87,Nl=[-19,-5,7,19],Pl=[-19,-5,9,19],Fl={xMin:Nl[0]+.5,xMax:Nl[3]-.5,yMin:.4,yMax:5.4,zMin:Pl[0]+.5,zMax:Pl[3]-.5,notchX:Nl[2],notchZ:Pl[1]},Il=new ji({color:16119283,roughness:.55,metalness:0,side:2});function Ll(e,t,n,r,i,a,o){let s=new Zr(new bi(i,a,o),Il);s.position.set(t,n,r),e.add(s)}function Rl(e,t,n,r,i){let a=i-kl/2,o=i+kl/2;a>t&&Ll(e,(t+a)/2,6/2,r,a-t,6,Ol),o<n&&Ll(e,(o+n)/2,6/2,r,n-o,6,Ol)}function zl(e,t,n,r,i){let a=i-kl/2,o=i+kl/2;a>n&&Ll(e,t,6/2,(n+a)/2,Ol,6,a-n),o<r&&Ll(e,t,6/2,(o+r)/2,Ol,6,r-o)}function Bl(e,t,n,r,i){let a=[...i].sort((e,t)=>e-t),o=t,s=6-Ml;for(let t of a){let n=t-Al/2,i=t+Al/2;n>o&&Ll(e,(o+n)/2,6/2,r,n-o,6,Ol),Ll(e,t,jl/2,r,Al,jl,Ol),Ll(e,t,Ml+s/2,r,Al,s,Ol),o=i}o<n&&Ll(e,(o+n)/2,6/2,r,n-o,6,Ol)}function Vl(e,t,n,r,i){let a=[...i].sort((e,t)=>e-t),o=n,s=6-Ml;for(let n of a){let r=n-Al/2,i=n+Al/2;r>o&&Ll(e,t,6/2,(o+r)/2,Ol,6,r-o),Ll(e,t,jl/2,n,Ol,jl,Al),Ll(e,t,Ml+s/2,n,Ol,s,Al),o=i}o<r&&Ll(e,t,6/2,(o+r)/2,Ol,6,r-o)}var Hl=new ji({color:8379354,transparent:!0,opacity:.3,side:0,depthWrite:!1,roughness:0,metalness:0});function Ul(e){let[t,n,r,i]=Nl,[a,o,s,c]=Pl,l=[3058602,2663843,3255980,2794916,2992294,2465951,2794658,2663331],u=[[t,a,n,o,0],[n,a,r,o,1],[t,o,n,s,2],[n,o,r,s,3],[r,o,i,s,4],[t,s,n,c,5],[n,s,r,c,6],[r,s,i,c,7]];for(let[t,n,r,i,a]of u){let o=new ji({color:l[a],roughness:.7,metalness:.05}),s=new Zr(new xi(r-t,i-n),o);s.rotation.x=-Math.PI/2,s.position.set((t+r)/2,0,(n+i)/2),e.add(s)}let d=.28,f=[[t,a,n,o],[n,a,r,o],[t,o,n,s],[n,o,r,s],[r,o,i,s],[t,s,n,c],[n,s,r,c],[r,s,i,c]];for(let[t,n,r,i]of f){let a=new Zr(new bi(r-t-d*2,6,i-n-d*2),Hl);a.position.set((t+r)/2,6/2,(n+i)/2),e.add(a)}Bl(e,t,r,a,[(t+n)/2,(n+r)/2]),Vl(e,r,a,o,[(a+o)/2]),Bl(e,r,i,o,[(r+i)/2]),Vl(e,i,o,c,[(o+s)/2,(s+c)/2]),Bl(e,t,i,c,[(t+n)/2,(n+r)/2,(r+i)/2]),Vl(e,t,a,c,[(a+o)/2,(o+s)/2,(s+c)/2]),zl(e,n,a,o,(a+o)/2),zl(e,n,o,s,(o+s)/2),zl(e,n,s,c,(s+c)/2),zl(e,r,o,s,(o+s)/2),zl(e,r,s,c,(s+c)/2),Rl(e,t,n,o,(t+n)/2),Rl(e,n,r,o,(n+r)/2),Rl(e,t,n,s,(t+n)/2),Rl(e,n,r,s,(n+r)/2),Rl(e,r,i,s,(r+i)/2);let p=(t,n)=>{let r=new ha(16777215,1.2,26,2);r.position.set(t,5.6,n),e.add(r)};p((t+n)/2,(a+o)/2),p((n+r)/2,(a+o)/2),p((t+n)/2,(o+s)/2),p((n+r)/2,(o+s)/2),p((r+i)/2,(o+s)/2),p((t+n)/2,(s+c)/2),p((n+r)/2,(s+c)/2),p((r+i)/2,(s+c)/2);let m=new Zr(new xi(200,200),new ji({color:13168622,roughness:1,metalness:0}));m.rotation.x=-Math.PI/2,m.position.y=-.05,e.add(m)}var Wl=[[-12,-12,14,14],[1,-12,12,14],[-12,2,14,14],[1,2,12,14],[13,2,12,14],[-12,14,14,10],[1,14,12,10],[13,14,12,10]],Gl=[],Kl=127/255,ql=219/255,Jl=218/255;function Yl(e,t){for(let t of Gl)t.value=e;ru(e,t);let n=Math.sin(e*.38)*.018+Math.sin(e*.67+1.1)*.01;Hl.color.setRGB(Kl+n,ql+n*.7,Jl+n*.5)}var Xl=`
uniform float time;
...
`;function Ql(e){let t={value:0};Gl.push(t);let n=new ki({uniforms:{time:t},vertexShader:Xl,fragmentShader:Zl,transparent:!0,side:2,depthWrite:!1}),r=6.04,i=new Zr(new xi(26,38,26,38),n);i.rotation.x=-Math.PI/2,i.position.set(-6,r,0),e.add(i);let a=new Zr(new xi(12,24,12,24),n);a.rotation.x=-Math.PI/2,a.position.set(13,r,7),e.add(a)}var $l=[Wl[0],Wl[2],Wl[4],Wl[7]],eu=45,tu=[];function nu(e){for(let[t,n,r,i]of $l){let a=eu,o=new Float32Array(a*3),s=new Float32Array(a);for(let e=0;e<a;e++)o[e*3]=t+(Math.random()-.5)*(r-2),o[e*3+1]=Math.random()*6,o[e*3+2]=n+(Math.random()-.5)*(i-2),s[e]=.35+Math.random()*.75;let c=new Or;c.setAttribute(`position`,new pr(o,3));let l=new mi(c,new li({color:16777215,size:.13,transparent:!0,opacity:.6,depthWrite:!1,sizeAttenuation:!0}));e.add(l),tu.push({points:l,pos:o,spd:s,cx:t,cz:n,w:r,d:i})}}function ru(e,t){for(let{points:n,pos:r,spd:i,cx:a,cz:o,w:s,d:c}of tu){let l=i.length;for(let n=0;n<l;n++)r[n*3+1]+=i[n]*t,r[n*3]+=Math.sin(e*1.8+n*1.37)*.004,r[n*3+1]>5.85&&(r[n*3]=a+(Math.random()-.5)*(s-2),r[n*3+1]=.1+Math.random()*.4,r[n*3+2]=o+(Math.random()-.5)*(c-2));n.geometry.attributes.position.needsUpdate=!0}}var iu=new ji({color:13150338,roughness:.85,metalness:0}),au=new ji({color:13553358,roughness:.75,metalness:.02}),ou=new ji({color:16052974,roughness:.65,metalness:0}),su=new ji({color:15130066,roughness:.9,metalness:0}),cu=new ji({color:3684406,roughness:.55,metalness:.08});function Q(e,t,n,r,i,a,o,s){let c=new Zr(new bi(a,o,s),t);c.position.set(n,i+o*.5,r),e.add(c)}function lu(e){Q(e,su,-12,-16.5,0,6,1,2),Q(e,su,-12,-17.4,1,6,.8,.3),Q(e,su,-15,-16.5,0,.4,1.5,2),Q(e,su,-9,-16.5,0,.4,1.5,2),Q(e,iu,-12,-14.2,0,2.5,.5,1.2),Q(e,cu,-16,-6.4,0,3.5,1,.6),Q(e,cu,-16,-6.4,1,3.5,.08,.6),Q(e,au,1,-17.6,0,9,2,1),Q(e,ou,1,-17.6,2,9,.1,1),Q(e,iu,1,-9,0,2.8,1.4,1.6),Q(e,iu,-.9,-9,0,1,.9,1),Q(e,iu,2.9,-9,0,1,.9,1),Q(e,iu,-.9,-9.4,.9,1,.7,.15),Q(e,iu,2.9,-9.4,.9,1,.7,.15),Q(e,su,-15.5,2,0,5,1.4,7.5),Q(e,ou,-15.5,-1.5,1.4,5,.25,1.5),Q(e,iu,-17.7,2,0,.4,2,7.5),Q(e,iu,-12.5,-1.5,0,2,1,2),Q(e,iu,-7.5,6.5,0,3,4,3),Q(e,ou,4.5,-2,0,3,.9,3.5),Q(e,au,4.5,-2,.9,3,.15,3.5),Q(e,ou,-2.5,-3,0,1.4,.9,1.8),Q(e,au,4.5,7,0,3,1.4,1.5),Q(e,ou,4.5,7,1.4,3,.1,1.5),Q(e,su,15.5,2,0,5,1.4,7.5),Q(e,ou,15.5,-1.5,1.4,5,.25,1.5),Q(e,iu,17.8,2,0,.4,2,7.5),Q(e,iu,9.5,-3,0,3,2.5,2),Q(e,iu,13.5,-1.5,0,2,1,2),Q(e,su,-15.5,16,0,4.5,1.4,5),Q(e,ou,-15.5,13.5,1.4,4.5,.25,1.5),Q(e,iu,-15.5,17.8,0,4.5,1.5,.4),Q(e,iu,-9,11,0,3.5,2.5,2),Q(e,ou,4.5,16.5,0,3,.9,4),Q(e,au,4.5,16.5,.9,3,.15,4),Q(e,ou,-2.5,11,0,1.4,.9,2),Q(e,au,-2,17,0,3,1.4,1.5),Q(e,ou,-2,17,1.4,3,.1,1.5),Q(e,iu,9.5,10.5,0,3,1.5,1.5),Q(e,iu,16.5,10.5,0,3.5,1.5,1.5),Q(e,au,9.5,12,0,1.5,.9,1.5),Q(e,au,9.5,12.7,.9,1.5,.7,.15),Q(e,iu,16,17,0,4.5,4,1.5)}var uu=[-19,-5,7,19],$=[-19,-5,9,19],du=3.8/2,fu=(e,t)=>[(e+t)/2-du,(e+t)/2+du],pu=[{axis:`x`,pos:uu[0],lo:$[0],hi:$[3],gaps:[]},{axis:`x`,pos:uu[3],lo:$[1],hi:$[3],gaps:[]},{axis:`x`,pos:uu[2],lo:$[0],hi:$[1],gaps:[]},{axis:`z`,pos:$[0],lo:uu[0],hi:uu[2],gaps:[]},{axis:`z`,pos:$[3],lo:uu[0],hi:uu[3],gaps:[]},{axis:`z`,pos:$[1],lo:uu[2],hi:uu[3],gaps:[]},{axis:`x`,pos:uu[1],lo:$[0],hi:$[3],gaps:[fu($[0],$[1]),fu($[1],$[2]),fu($[2],$[3])]},{axis:`x`,pos:uu[2],lo:$[1],hi:$[3],gaps:[fu($[1],$[2]),fu($[2],$[3])]},{axis:`z`,pos:$[1],lo:uu[0],hi:uu[2],gaps:[fu(uu[0],uu[1]),fu(uu[1],uu[2])]},{axis:`z`,pos:$[2],lo:uu[0],hi:uu[3],gaps:[fu(uu[0],uu[1]),fu(uu[1],uu[2]),fu(uu[2],uu[3])]}],mu=new G;function hu(e,t,n){mu.set(0,0,0);for(let r of pu){let i=r.axis===`x`,a=i?e.x:e.z,o=i?e.z:e.x,s=i?t.x:t.z,c=i?t.z:t.x,l=a-r.pos,u=l>=0?1:-1;if(s*u>=0)continue;let d=Math.abs(l);if(d>n||o<r.lo||o>r.hi)continue;let f=Math.abs(s)>.02?o+d/Math.abs(s)*c:o;if(r.gaps.some(([e,t])=>f>e&&f<t))continue;let p=1.5,m=d<=p?1:1-(d-p)/Math.max(n-p,.01);i?mu.x+=u*m:mu.z+=u*m}let r=Fl,i=1.5;return t.y<0&&e.y-r.yMin<i&&(mu.y+=(1-(e.y-r.yMin)/i)*.7),t.y>0&&r.yMax-e.y<i&&(mu.y-=(1-(r.yMax-e.y)/i)*.7),mu}var gu=new rl({antialias:!0});gu.setSize(window.innerWidth,window.innerHeight),gu.setPixelRatio(window.devicePixelRatio),gu.outputColorSpace=Re,document.body.appendChild(gu.domElement);var _u=new Pn;_u.background=new J(15661818),_u.fog=new Nn(13693680,.0035);var vu=new pa(50,window.innerWidth/window.innerHeight,.1,500);vu.position.set(20,52,48),vu.lookAt(0,2,0),window.addEventListener(`resize`,()=>{vu.aspect=window.innerWidth/window.innerHeight,vu.updateProjectionMatrix(),gu.setSize(window.innerWidth,window.innerHeight)});var yu=new pl(vu,gu.domElement);yu.target.set(0,6/2,0),yu.enableDamping=!0,yu.dampingFactor=.06,yu.autoRotate=!1,yu.minDistance=15,yu.maxDistance=130,yu.maxPolarAngle=Math.PI*.78,_u.add(new ya(13693168,2.8));var bu=new va(16777215,2.2);bu.position.set(-10,60,-20),_u.add(bu);var xu=new va(16773352,.9);xu.position.set(30,25,30),_u.add(xu),Ul(_u),Ql(_u),nu(_u);var Su={MediumFishA:{fishLength:10,fishWaveLength:-2,fishBendAmount:2,tailSpeed:.4,swimSpeed:1.4,turnRate:2.2,scale:.24},MediumFishB:{fishLength:10,fishWaveLength:-2,fishBendAmount:2,tailSpeed:1.2,swimSpeed:1.3,turnRate:2.2,scale:.32},SmallFishA:{fishLength:10,fishWaveLength:1,fishBendAmount:2,tailSpeed:4,swimSpeed:2.2,turnRate:5,scale:.6}},Cu=[{type:`SmallFishA`,count:120},{type:`MediumFishA`,count:40},{type:`MediumFishB`,count:40}],wu=new G(-10,60,-20),Tu=[new G(2.2,.55,.08),new G(2.2,1.7,.05),new G(.1,.65,2.4),new G(.1,2,.75),new G(2.2,.08,.15),new G(1.3,.1,2.4),new G(2.2,.18,1.3),new G(.1,2,2.2)];function Eu(e,t,n,r){return new ki({uniforms:{time:{value:0},fishLength:{value:n.fishLength},fishWaveLength:{value:n.fishWaveLength},fishBendAmount:{value:n.fishBendAmount},lightWorldPos:{value:wu},diffuseMap:{value:e},normalMapTex:{value:t},tintColor:{value:r},lightColor:{value:new Gt(1,1,1,1)},ambient:{value:new Gt(.55,.6,.62,1)},specular:{value:new Gt(.9,.95,1,1)},shininess:{value:50},specularFactor:{value:1}},vertexShader:El,fragmentShader:Dl,side:0})}var Du=new ea;function Ou(e,t=!0){return new Promise(n=>{Du.load(`/3D-aquarium-demo/assets/${e}`,e=>{e.colorSpace=t?Re:ze,n(e)},void 0,()=>n(null))})}async function ku(e){let{fields:t,textures:n}=(await(await fetch(`/3D-aquarium-demo/assets/${e}.js`)).json()).models[0],r=new Or;r.setAttribute(`position`,new pr(new Float32Array(t.position.data),3)),r.setAttribute(`normal`,new pr(new Float32Array(t.normal.data),3)),r.setAttribute(`uv`,new pr(new Float32Array(t.texCoord.data),2)),r.setAttribute(`a_tangent`,new pr(new Float32Array(t.tangent.data),3)),r.setAttribute(`a_binormal`,new pr(new Float32Array(t.binormal.data),3)),r.setIndex(new pr(new Uint16Array(t.indices.data),1)),r.computeBoundingBox();let i=new G;r.boundingBox.getCenter(i),r.translate(-i.x,-i.y,-i.z);let[a,o]=await Promise.all([n.diffuse?Ou(n.diffuse,!0):Promise.resolve(null),n.normalMap?Ou(n.normalMap,!1):Promise.resolve(null)]);return{geo:r,diffuseMap:a,normalMapTex:o}}function Au(e,t){return e+Math.random()*(t-e)}function ju(){let e=Math.random()*Math.PI*2,t=Au(-.12,.12);return new G(Math.cos(e),t,Math.sin(e)).normalize()}var Mu=[{xMin:-19,xMax:-5,zMin:-19,zMax:-5},{xMin:-5,xMax:7,zMin:-19,zMax:-5},{xMin:-19,xMax:-5,zMin:-5,zMax:9},{xMin:-5,xMax:7,zMin:-5,zMax:9},{xMin:7,xMax:19,zMin:-5,zMax:9},{xMin:-19,xMax:-5,zMin:9,zMax:19},{xMin:-5,xMax:7,zMin:9,zMax:19},{xMin:7,xMax:19,zMin:9,zMax:19}];function Nu(e){let t=Fl;return new G(Au(Math.max(e.xMin+2,t.xMin),Math.min(e.xMax-2,t.xMax)),Au(t.yMin+.3,t.yMax-.3),Au(Math.max(e.zMin+2,t.zMin),Math.min(e.zMax-2,t.zMax)))}var Pu=new G;function Fu(e,t,n,r){Pu.set(0,0,0);let i=.8,a=n.xMin+i,o=n.xMax-i,s=n.zMin+i,c=n.zMax-i;return t.x<0&&e.x-a<r&&(Pu.x+=1-(e.x-a)/r),t.x>0&&o-e.x<r&&(Pu.x-=1-(o-e.x)/r),t.z<0&&e.z-s<r&&(Pu.z+=1-(e.z-s)/r),t.z>0&&c-e.z<r&&(Pu.z-=1-(c-e.z)/r),Pu}var Iu=new G;function Lu(e,t,n,r){let i=.55,a=Fl,o=n.xMin+i,s=n.xMax-i,c=n.zMin+i,l=n.zMax-i,u=a.yMin,d=a.yMax;Iu.copy(t);let f=!1;e.x<o&&(e.x=o,Iu.x<0&&(Iu.x*=-1,f=!0)),e.x>s&&(e.x=s,Iu.x>0&&(Iu.x*=-1,f=!0)),e.z<c&&(e.z=c,Iu.z<0&&(Iu.z*=-1,f=!0)),e.z>l&&(e.z=l,Iu.z>0&&(Iu.z*=-1,f=!0)),e.y<u&&(e.y=u,Iu.y<0&&(Iu.y*=-1,f=!0)),e.y>d&&(e.y=d,Iu.y>0&&(Iu.y*=-1,f=!0)),f&&t.lerp(Iu.normalize(),Math.min(1,r*6)).normalize()}var Ru=document.getElementById(`loading-fill`),zu=document.getElementById(`loading-pct`);function Bu(e){let t=Math.round(e*100);Ru&&(Ru.style.width=t+`%`),zu&&(zu.textContent=t+`%`)}function Vu(){let e=document.getElementById(`loading`);e&&(e.classList.add(`fade-out`),e.addEventListener(`transitionend`,()=>e.remove(),{once:!0}))}var Hu=[];async function Uu(){let e=[...new Set(Cu.map(e=>e.type))],t=e.length,n=0;Bu(.05);let r=Object.fromEntries(await Promise.all(e.map(async e=>{let r=await ku(e);return n++,Bu(.05+n/t*.9),[e,r]}))),i=[],a=[30,26,30,26,26,22,20,20],o=[];a.forEach((e,t)=>{for(let n=0;n<e;n++)o.push(Mu[t])});for(let e=o.length-1;e>0;e--){let t=Math.floor(Math.random()*(e+1));[o[e],o[t]]=[o[t],o[e]]}let s=0;for(let{type:e,count:t}of Cu){let{geo:n,diffuseMap:a,normalMapTex:c}=r[e],l=Su[e];for(let r=0;r<t;r++){let t=o[s++],r=Tu[Math.floor(Math.random()*Tu.length)],u=new Zr(n,Eu(a,c,l,r));u.scale.setScalar(l.scale);let d;for(let e=0;e<150&&(d=Nu(t),!i.every(e=>e.distanceTo(d)>=2.5));e++);i.push(d.clone()),u.position.copy(d);let f=ju(),p=f.clone(),m=e.startsWith(`Small`)?Au(.7,1.6):Au(.6,1.4),h=l.swimSpeed*m,g=(t.xMin+t.xMax)/2,_=(t.zMin+t.zMax)/2,v=(t.xMax-t.xMin)/2,y=(t.zMax-t.zMin)/2,b=new W(g+Au(-v*.25,v*.25),_+Au(-y*.25,y*.25)),x=Math.min(v,y)*.55,S=Au(2,Math.max(2.5,x)),C=Math.random()<.5?1:-1;Hu.push({mesh:u,pos:d,vel:f,smoothVel:f.clone(),facingDir:p,room:t,circleCenter:b,circleRadius:S,orbitDir:C,swimSpeed:h,currentSpeed:h,targetSpeed:h,tailSpeed:l.tailSpeed*Au(.75,1.3),turnRate:l.turnRate,timeOffset:Math.random()*Math.PI*2,wanderPhase:Math.random()*Math.PI*2,pauseTimer:0,pauseChance:Au(1e-4,4e-4),speedWaveFreq:Au(.2,.6),speedWavePhase:Math.random()*Math.PI*2,speedWaveAmt:Au(.15,.28)}),_u.add(u)}}Bu(1),setTimeout(Vu,300)}var Wu=new wa,Gu=0;function Ku(){requestAnimationFrame(Ku),Wu.update();let e=Wu.getElapsed(),t=Math.min(e-Gu,.05);Gu=e;for(let n of Hu){{let r=n.pos.x-n.circleCenter.x,i=n.pos.z-n.circleCenter.z,a=Math.atan2(i,r)+n.orbitDir*.5,o=n.circleCenter.x+n.circleRadius*Math.cos(a),s=n.circleCenter.z+n.circleRadius*Math.sin(a),c=o-n.pos.x,l=s-n.pos.z,u=Math.sqrt(c*c+l*l);if(u>.01){let r=Math.sin(e*.4+n.wanderPhase)*.06,i=new G(c/u,r,l/u).normalize();n.vel.lerp(i,n.turnRate*t*1.5).normalize()}}{let e=3+n.swimSpeed*.3,r=hu(n.pos,n.vel,e),i=r.length();if(i>.001){let e=Math.min(1,n.turnRate*i*t*6);n.vel.lerp(r.normalize(),e).normalize()}}{let e=Fu(n.pos,n.vel,n.room,3.5),r=e.length();if(r>.001){let i=Math.min(1,n.turnRate*r*t*8);n.vel.lerp(e.normalize(),i).normalize()}}n.smoothVel.lerp(n.vel,Math.min(1,t*3.5)).normalize(),n.pauseTimer>0?(n.pauseTimer-=t,n.targetSpeed=0):(n.targetSpeed=n.swimSpeed*(1+n.speedWaveAmt*Math.sin(e*n.speedWaveFreq+n.speedWavePhase)),Math.random()<n.pauseChance&&(n.pauseTimer=Au(.6,2.8))),n.currentSpeed=Dt.lerp(n.currentSpeed,n.targetSpeed,Math.min(1,t*2.2)),n.pos.addScaledVector(n.smoothVel,n.currentSpeed*t),Lu(n.pos,n.vel,n.room,t),n.facingDir.lerp(n.smoothVel,Math.min(1,n.turnRate*t)).normalize(),n.mesh.position.copy(n.pos),n.mesh.rotation.y=Math.atan2(n.facingDir.x,n.facingDir.z),n.mesh.rotation.x=-Math.asin(Math.max(-.9,Math.min(.9,n.facingDir.y)));let r=n.tailSpeed*(n.currentSpeed/Math.max(n.swimSpeed,.01));n.mesh.material.uniforms.time.value=e*r+n.timeOffset}Yl(e,t),yu.update(),gu.render(_u,vu)}lu(_u),Uu().catch(console.error),Ku();